...
<body style="background-color: rgb(83, 80, 80);">
    ...
    <div id="image-container">
        <h1 data-value="Map Name">Anubis</h1>
        <div class="image T">
            <img src="anubis/AnubisEboxT.JPG" alt="T 1" onmouseover="hover(this, 'anubis/AnubisEboxTVid.gif');" onmouseout="hover(this,'anubis/AnubisEboxT.JPG');">
            <div class="overlay-text">
                <p>E Box</p>
            </div>
        </div>
        <div class="image T">
            <img src="anubis/AnubisHouseT.JPG" alt="T 2" onmouseover="hover(this, 'anubis/AnubisHouseT.gif');" onmouseout="hover(this,'anubis/AnubisHouseT.JPG');">
            <div class="overlay-text">
                <p>House</p>
            </div>
        </div>
